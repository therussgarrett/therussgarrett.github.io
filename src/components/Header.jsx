export default function Header() {
  return ( <
    header className = "bg-gray-600 py-16 text-white pl-10" >
    <
    h1 className = "text-7xl" > Russ Garrett < /h1> <
    ...
    /div> <
    p className = "text-2xl" > Software Engineer(Full - Stack Web) < /p> <
    div style = {
      {
        display: 'flex',
        gap: '1.5rem',
    ...
    <
    a href = "https://github.com/Russell-Savage"
    target = "_blank"
    ...
    <
    a href = "https://www.linkedin.com/in/russell-g-4169b111a/"
    target = "_blank"
    rel = "noopener noreferrer"
    style = {
      {
